...
create unique index _jomisacu_actor_permission_relations_unique_rule
    on _jomisacu_actor_permission_relations (context_id, actor_id, permission_id, negated, resource);
...
create unique index _jomisacu_role_permission_relations_unique_rule
    on _jomisacu_role_permission_relations (context_id, role_id, permission_id, negated, resource);
